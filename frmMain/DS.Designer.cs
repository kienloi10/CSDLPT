...
namespace frmMain.DSTableAdapters {
...
SELECT MASV, MAMH, LAN, NGAYTHI, DIEM, BAITHI FROM BANGDIEM WHERE (LAN = @LAN) AND (MAMH = @MAMH) AND (MASV = @MASV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::frmMain.Properties.Settings.Default.TRACNGHIEMConnectionString1;
        }
...
SELECT MAGV, MAMH, MALOP, TRINHDO, NGAYTHI, LAN, SOCAUTHI, THOIGIAN FROM GIAOVIEN_DANGKY WHERE (LAN = @LAN) AND (MALOP = @MALOP) AND (MAMH = @MAMH)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MAGV, MAMH, MALOP, TRINHDO, NGAYTHI, LAN, SOCAUTHI, THOIGIAN  FROM dbo.GIA" +
                "OVIEN_DANGKY";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
